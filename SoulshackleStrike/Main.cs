...
namespace SoulshackleStrike
{
    public static class Main
    {
        ...
        internal static void OnGameReady()
        {
            ...
            //
            skeleton.GuiPresentation.Title = "SoulshackleStrike/&FancySkeletonTitle";
            skeleton.GuiPresentation.Description = "SoulshackleStrike/&FancySkeletonDescription";
        }
    }
}
